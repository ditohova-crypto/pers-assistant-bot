...
KIMI_API_KEY = os.environ.get("KIMI_API_KEY", "")  # Moonshot API ключ
...
MODEL = "moonshot-v1-8k"  # Или moonshot-v1-32k для длинных контекстов
...
async def main():
    ...
    print("Кими запущен для Дианы! (Moonshot API)")
